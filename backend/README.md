...
## Project Structure
    ...
    ├── testapiautocatalog_115066  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_115066`
...
2. Clone this repo and `cd testapiautocatalog_115066`
